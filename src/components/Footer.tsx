      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-4 md:px-6">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/produtos" search={{ cat: "Rações", q: undefined }} className="hover:text-primary">Rações</Link></li>
            <li><Link to="/produtos" search={{ cat: "Brinquedos", q: undefined }} className="hover:text-primary">Brinquedos</Link></li>
            <li><Link to="/produtos" search={{ cat: "Higiene", q: undefined }} className="hover:text-primary">Higiene</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="mt-3 flex gap-2">
            ...
            <a href="#" aria-label="Facebook" className="grid h-9 w-9 place-items-center rounded-full bg-background shadow-card transition hover:bg-primary hover:text-primary-foreground"><Facebook className="h-4 w-4" /></a>
          </div>
        </div>
      </div>
