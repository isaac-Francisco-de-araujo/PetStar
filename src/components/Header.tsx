        ...
        <nav className="ml-auto hidden items-center gap-1 md:flex">
          ...
          {user ? (
            <div className="flex items-center gap-2">
              <span className="rounded-full bg-secondary px-3 py-1.5 text-xs font-medium">Olá, {user.name}</span>
      ...
      {open && (
        <div className="border-t border-border bg-background md:hidden">
          ...
          <nav className="flex flex-col gap-1 px-3 pb-4">
            <Link to="/" onClick={() => setOpen(false)} className="rounded-lg px-3 py-2.5 text-sm font-semibold hover:bg-secondary">Início</Link>
            <Link to="/produtos" onClick={() => setOpen(false)} className="rounded-lg px-3 py-2.5 text-sm font-semibold hover:bg-secondary">Produtos</Link>
            <Link to="/servicos" onClick={() => setOpen(false)} className="rounded-lg px-3 py-2.5 text-sm font-semibold hover:bg-secondary">Serviços</Link>
            <Link to="/carrinho" onClick={() => setOpen(false)} className="rounded-lg px-3 py-2.5 text-sm font-semibold hover:bg-secondary">Carrinho</Link>
            {user ? (
